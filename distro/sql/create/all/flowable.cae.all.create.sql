...
(
    ...
    HAS_GRAPHICAL_NOTATION_ boolean                 NULL,
...
(
    ...
    IS_COMPLETEABLE_        boolean                 NULL,
    IS_COUNT_ENABLED_       boolean                 NULL,
    VAR_COUNT_              INT                     NULL,
...
(
    ...
    ENTRY_CRITERION_ID_    VARCHAR(255)            NULL,
    EXIT_CRITERION_ID_     VARCHAR(255)            NULL,
    SHOW_IN_OVERVIEW_      boolean                 NULL,
    EXTRA_VALUE_           VARCHAR(255)            NULL,
    DERIVED_CASE_DEF_ID_   VARCHAR(255)            NULL,
    LAST_UNAVAILABLE_TIME_ datetime(3)             NULL,
    TENANT_ID_             VARCHAR(255) DEFAULT '' NULL,
...
CREATE TABLE ACT_DMN_HI_DECISION_EXECUTION (ID_ VARCHAR(255) NOT NULL, DECISION_DEFINITION_ID_ VARCHAR(255) NULL, DEPLOYMENT_ID_ VARCHAR(255) NULL, START_TIME_ datetime(3) NULL, END_TIME_ datetime(3) NULL, INSTANCE_ID_ VARCHAR(255) NULL, EXECUTION_ID_ VARCHAR(255) NULL, ACTIVITY_ID_ VARCHAR(255) NULL, FAILED_ boolean DEFAULT 0 NULL, TENANT_ID_ VARCHAR(255) NULL, EXECUTION_JSON_ CLOB NULL, CONSTRAINT PK_ACT_DMN_HI_DECISION_EXECUTION PRIMARY KEY (ID_));
