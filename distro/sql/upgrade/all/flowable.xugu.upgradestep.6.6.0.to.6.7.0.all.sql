...
UPDATE FLW_EV_DATABASECHANGELOGLOCK SET `LOCKED` = TRUE, LOCKEDBY = '192.168.10.1 (192.168.10.1)', LOCKGRANTED = '2021-08-30 14:08:05.652' WHERE ID = 1 AND `LOCKED` = FALSE;
